// Navbar Toggle for Mobile
       ...
       function copyToClipboard(element) {
           const hexCode = element.getAttribute("data-color");
           navigator.clipboard.writeText(hexCode).then(() => {
               console.log(`Copied ${hexCode} to clipboard`);
               element.classList.add("copied"); // Add "copied" class to show "Copied!" text
               setTimeout(() => {
                   element.classList.remove("copied"); // Reset after 2 seconds
               }, 2000);
           }).catch(err => {
